...
- (void)loadPhotos
{
    ...
    HX_AssetManager *assetManger = [HX_AssetManager sharedManager];
    ...
    [assetManger getAllAlbumWithStart:^{
        ...
        assetManger.recordOriginal = assetManger.ifOriginal;
        
        [assetManger.recordPhotos removeAllObjects];
        for (int i = 0 ; i < assetManger.selectedPhotos.count; i++) {
            HX_PhotoModel *model = assetManger.selectedPhotos[i];
            
            [assetManger.recordPhotos addObject:model];
        }
        ...
        if (assetManger.selectedPhotos.count == 0) {
            ...
            HX_PhotoModel *model = assetManger.selectedPhotos.lastObject;
