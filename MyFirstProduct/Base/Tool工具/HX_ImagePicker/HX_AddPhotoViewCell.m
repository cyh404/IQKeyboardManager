...
- (void)setup
{
    ...
    imageView.frame = CGRectMake(0, 5, width-5, height-5);
    [self.contentView addSubview:imageView];
    _imageView = imageView;
    
    UILabel *tipLabel = [[UILabel alloc]init];
    tipLabel.frame = CGRectMake(5, width-25, width-10, 20);
    tipLabel.textColor = [[UIColor lightGrayColor] colorWithAlphaComponent:0.8];
    ...
    deleteBtn.frame = CGRectMake(width - 25, 0, 25, 25);
