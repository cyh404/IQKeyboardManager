...
#import "JKNormalPickerView.h"

@interface JKNormalPickerView()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation JKNormalPickerView
#pragma mark - 懒加载
- (UIView *)lineView
{
    if (!_lineView) {
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view
{
    ...
    NSString *text = self.selectArr[row];
...
{
    if (self.selectBlock) {
        self.selectBlock(self.selectIndex,self.selectArr[self.selectIndex]);
    }
    [self remove];
}
