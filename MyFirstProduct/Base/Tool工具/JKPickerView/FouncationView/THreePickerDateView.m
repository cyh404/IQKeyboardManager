//
//  THreePickerDateView.m
//  AoBoRui
//
//  Created by kunge on 2016/12/29.
//  Copyright © 2016年 kunge. All rights reserved.
//

#import "THreePickerDateView.h"
#import "NSCalendar+ST.h"

@interface THreePickerDateView()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation THreePickerDateView
...
- (void)setupUI {
    ...
    NSString *resultDate = [self computeDateWithDays:2];
    ZJLog(@"resultDate===%@",resultDate);
...
- (NSString *)computeDateWithDays:(NSInteger)days
{
    ...
    NSTimeInterval interval = 60 * 24*60 * days;
