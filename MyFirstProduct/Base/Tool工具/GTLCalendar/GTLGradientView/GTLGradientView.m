...
- (void)setupInitValues {
    ...
    UIColor *currentAppColor = [UIColor colorWithRGBHexString:@"F09070"];
    self.gradientLayer.colors = @[(id)currentAppColor.CGColor, (id)currentAppColor.CGColor];//@[(id)squashColor.CGColor, (id)dustyOrangeColor.CGColor];
